...
require "rails"
# Load only the frameworks this app uses. Action Cable is intentionally
# omitted — there are no channels or broadcasts, so real-time messaging
# (and its database) is not provisioned. See the deploy-backend spec.
